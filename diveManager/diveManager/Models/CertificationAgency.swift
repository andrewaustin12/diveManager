...
enum CertificationAgency: String, CaseIterable, Codable, Identifiable {
    ...
    enum PADI: String, CaseIterable, Identifiable {
        ...
        case tecSidemountInstructor = "Tec Sidemount Instructor"
    ...
    enum SSI: String, CaseIterable, Identifiable {
    ...
    enum SDI: String, CaseIterable, Identifiable {
        ...
        // Add more SDI courses as needed

        var id: String { self.rawValue }
    }

    enum TDI: String, CaseIterable, Identifiable {
        case nitroxDiver = "Nitrox Diver"
        ...
        // Add more TDI courses as needed

        var id: String { self.rawValue }
    }

    enum RAID: String, CaseIterable, Identifiable {
        case openWaterDiver = "Open Water Diver"
        ...
        // Add more RAID courses as needed

        var id: String { self.rawValue }
    }

    enum NAUI: String, CaseIterable, Identifiable {
